...
start_date <- as.Date('2015-04-05', tz = "America/Chicago")
end_date <- as.Date('2015-10-04', tz = "America/Chicago")
...
csv_file_path <- "/Volumes/files/data/mlb/savant/2015/pbp_regular_season_2015.csv"
db_file_path <- "/Volumes/files/data/mlb/savant/2015/pbp_regular_season_2015.db"
...
save.image("/Volumes/files/data/mlb/savant/2015/pbp_regular_season_2015.RData")
