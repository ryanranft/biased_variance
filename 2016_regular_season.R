...
start_date <- as.Date('2016-04-03', tz = "America/Chicago")
end_date <- as.Date('2016-10-02', tz = "America/Chicago")
...
csv_file_path <- "/Volumes/files/data/mlb/savant/2016/pbp_regular_season_2016.csv"
db_file_path <- "/Volumes/files/data/mlb/savant/2016/pbp_regular_season_2016.db"
...
save.image("/Volumes/files/data/mlb/savant/2016/pbp_regular_season_2016.RData")