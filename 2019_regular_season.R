...
conn <- dbConnect(RSQLite::SQLite(), "/Volumes/files/data/mlb/savant/2019/pbp_regular_season_2019.db")
dbWriteTable(conn, "all_data", all_data, overwrite = TRUE)
dbDisconnect(conn)

# Save the workspace image
save.image("/Volumes/files/data/mlb/savant/2019/pbp_regular_season2019.RData")
