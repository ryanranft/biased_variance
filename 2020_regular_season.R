...
start_date <- as.Date('2020-07-23', tz = "America/Chicago")
end_date <- as.Date('2020-09-27', tz = "America/Chicago")
...
csv_file_path <- "/Volumes/files/data/mlb/savant/2020/pbp_regular_season_2020.csv"
db_file_path <- "/Volumes/files/data/mlb/savant/2020/pbp_regular_season_2020.db"
...
save.image("/Volumes/files/data/mlb/savant/2020/pbp_regular_season_2020.RData")
