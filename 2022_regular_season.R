...
start_date <- as.Date('2022-04-07', tz = "America/Chicago")
end_date <- as.Date('2022-10-05', tz = "America/Chicago")
...
csv_file_path <- "/Volumes/files/data/mlb/savant/2022/pbp_regular_season_2022.csv"
db_file_path <- "/Volumes/files/data/mlb/savant/2022/pbp_regular_season_2022.db"
...
save.image("/Volumes/files/data/mlb/savant/2022/pbp_regular_season_2022.RData")